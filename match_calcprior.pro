...
common fitrayleigh_block, all_r, all_rcen, excess, excess_err
  ...
  for i=0, nr-1 do begin
    ...
    xyouts, 0.02, 0.95, 'FG Masked Measurement Annuli', charsize=1.5, $
            charthick=3.0, $
            /normal, color=255
    xyouts, 0.02, 0.95, 'FG Masked Measurement Annuli', charsize=1.5, /normal
  ...
  ; overplot high-res sampled version of the smooth distribution
  ...
  print, "Best SNR at search radius of " + $
         string(all_r[maxind],format='(F5.1)') + " arcsec"
